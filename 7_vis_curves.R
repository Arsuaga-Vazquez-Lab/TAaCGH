...
# param <- "B0";
# phenotype <- "lumA";
# dataSet <- "horlings_update_segments";
...
Path <- paste(begPath, "Results", dataSet, "significance", "pvals", sep="/");
...
curveFolder = paste(begPath, 'Results', dataSet, 'vis', 'curves', "2D", param, phenotype, sep='/');
